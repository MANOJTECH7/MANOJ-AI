...
> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴀɴᴏᴊ-ᴛᴇᴄʜ`;
                ...
                const handleDownloadOption = async (optionUpdate) => {
                    ...
                    if (isReplyToOptMsg) {
                        ...
                        const caption = `🔞 *𝐌𝐀𝐍𝐎𝐉-𝐀𝐈 XVIDEO DOWNLOADER* 🔞\n\n📽️ *Title*: ${xv_info.result.title}\n> 𝐌𝐀𝐍𝐎𝐉-𝐀𝐈ʳ`;
