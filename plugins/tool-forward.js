...
cmd({
  ...
  return await message.reply(
    "❌ Invalid group JID or phone number.\n" +
    "Example usage:\n" +
    ".fwd 987654321098765432@g.us (for a group)\n" +
    "or\n" +
    ".fwd 917005439105 (for a phone number)"
  );
}
    ...
    const senderName = "Manoj-Ai"; // Your name hardcoded
    ...
    await message.reply(
      ...
      `Please check:\n` +
      `1. Target format (e.g., 987654321098765432@g.us or 919341378016)\n` +
