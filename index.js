...
const ownerNumber = ['917005439105','919341378016']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.split("Manoj-Ai=")[1];
...
console.log("Connecting Manoj-Ai bot 🧬...");
...
require("./plugins/" + plugin);
    ...
    console.log("Manoj-Ai Bot connected to WhatsApp ✅");

let up = `🔵 Initializing Connection to Manoj-Ai Bot...  
🔵 Authenticating Secure Session...  
🔵 Encrypting Data Stream...  
✅ Connected Successfully!  

━━━━━━━━━━━━━━━━━━━━━━  
*😈 Manoj-Ai OFFICIAL WHATSAPP BOT*  
━━━━━━━━━━━━━━━━━━━━━━  
╭─〔🌐 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𝐂𝐇𝐀𝐍𝐍𝐄𝐋〕─╮  
...
conn.sendMessage(conn.user.id,{ image: { url: `https://files.catbox.moe/zxtxit.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("917005439105")){
if(isReact) return
m.react("💎")
}
